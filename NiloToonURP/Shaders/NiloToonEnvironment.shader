...
// This shader is a direct copy of URP10.4.0's Lit.shader, but with some edit.
// If you want to see what is the difference, all edited lines will have a [NiloToon] tag, you can search [NiloToon] in this file,
// or compare URP10.4.0's Lit.shader with this file using tools like SourceGear DiffMerge.
