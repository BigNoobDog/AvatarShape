// original sources: https://github.com/Jason-Ma-233/JasonMaToonRenderPipeline/blob/master/Assets/JTRP/Editor/GUI/LWGUI/DrawerUtility.cs
// all NiloToonURP edited lines will have tag [NiloToonURP XXX] to mark what the change is
...
// [NiloToonURP added]
// to remove C# dependency to TCP2
//===================================================
/*
//===================================================
...
namespace JTRP.ShaderDrawer
{
    ...
    public class Func
    {
        ...
        public static void SetShaderKeyWord(UnityEngine.Object[] materials, string keyWord, bool isEnable)
        {
            ...
            {
                // [NiloToonURP added (2021-07-30)]
                // to keep material saved keywords works following class MainDrawer(inside ShaderDrawer.cs)'s design (keyword：_为忽略，不填和__为属性名大写 + _ON)
                // After adding this section, no more "_" keywords will be saved in material, and all old material will remove keyword "_" if detected
                // *disable this section will make NiloToonURP's screen space outline flicker in scene window
                //====================================
                if(keyWord == "_")
                {
        ...
        public static void RampProperty(MaterialProperty prop, string label, MaterialEditor editor, Gradient gradient, AssetImporter assetImporter, string defaultFileName = "JTRP_RampMap")
        {
            // [NiloToonURP added]
            //=============================================================
            // removed ramp texture property in this file, since we can't include TCP2 in NiloToonURP
