...
namespace MagicaCloth
{
    ...
    public class MagicaMeshCloth : BaseCloth
    {
        ...
        /// </summary>
        [SerializeField]
        public MagicaVirtualDeformer virtualDeformer = null;

        [SerializeField]
        public int virtualDeformerHash;
        [SerializeField]
        public int virtualDeformerVersion;
        ...
        void ResetParams()
        {
            ...
            clothParams.SetClampDistanceRatio(true, 0.5f, 1.05f);
